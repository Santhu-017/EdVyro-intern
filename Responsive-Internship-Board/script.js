...
function renderInternships(data, clearBoard = true) {
    ...
    pageData.forEach((internship, index) => {
        ...
        const matchScore = 80 + (internship.id % 20); // Mock AI Match Score

        card.innerHTML = `
            <div class="match-badge"><i class="ph ph-sparkle"></i> ${matchScore}% Match</div>
...
function renderApplications() {
    ...
    const stats = { applied: myApplications.length, review: 0, interview: 0, accepted: 0 };
